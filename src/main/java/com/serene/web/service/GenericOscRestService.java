...
public interface GenericOscRestService {
	...
	public String getByExternalSystemId(String url, String externalSystemIdFieldName, Object externalSystemIdFieldValue) throws ClientProtocolException, IOException;
}
